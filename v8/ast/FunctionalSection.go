...
func (v *functionalSection_) GetFunctionalDeclarations() com.Sequential[FunctionalDeclarationLike] {
...
type functionalSection_ struct {
	...
	delimiter_              string
	functionalDeclarations_ com.Sequential[FunctionalDeclarationLike]
}
