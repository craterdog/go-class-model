...
type AspectSectionClassLike interface {
	...
	AspectSection(
		delimiter string,
		aspectDeclarations com.Sequential[AspectDeclarationLike],
	) AspectSectionLike
}
...
type ClassSectionClassLike interface {
	...
	ClassSection(
		delimiter string,
		classDeclarations com.Sequential[ClassDeclarationLike],
	) ClassSectionLike
}
...
type ConstantSubsectionClassLike interface {
	...
	ConstantSubsection(
		delimiter string,
		constantMethods com.Sequential[ConstantMethodLike],
...
type ConstructorSubsectionClassLike interface {
	...
	ConstructorSubsection(
		delimiter string,
		constructorMethods com.Sequential[ConstructorMethodLike],
...
type FunctionSubsectionClassLike interface {
	...
	FunctionSubsection(
		delimiter string,
		functionMethods com.Sequential[FunctionMethodLike],
...
type FunctionalSectionClassLike interface {
	...
	FunctionalSection(
		delimiter string,
		functionalDeclarations com.Sequential[FunctionalDeclarationLike],
...
type InstanceSectionClassLike interface {
	...
	InstanceSection(
		delimiter string,
		instanceDeclarations com.Sequential[InstanceDeclarationLike],
	) InstanceSectionLike
}
...
type PrincipalSubsectionClassLike interface {
	...
	PrincipalSubsection(
		delimiter string,
		principalMethods com.Sequential[PrincipalMethodLike],
...
type TypeSectionClassLike interface {
	...
	TypeSection(
		delimiter string,
		typeDeclarations com.Sequential[TypeDeclarationLike],
	) TypeSectionLike
}
...
type ArgumentsLike interface {
	...
	GetArgument() ArgumentLike
	GetAdditionalArguments() com.Sequential[AdditionalArgumentLike]
...
type AspectDeclarationLike interface {
	...
	GetDelimiter1() string
	GetDelimiter2() string
	GetAspectMethods() com.Sequential[AspectMethodLike]
...
type AspectSectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetAspectDeclarations() com.Sequential[AspectDeclarationLike]
}
...
type AspectSubsectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetAspectInterfaces() com.Sequential[AspectInterfaceLike]
}
...
type AttributeSubsectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetAttributeMethods() com.Sequential[AttributeMethodLike]
}
...
type ClassSectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetClassDeclarations() com.Sequential[ClassDeclarationLike]
}
...
type ConstantSubsectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetConstantMethods() com.Sequential[ConstantMethodLike]
}
...
type ConstraintsLike interface {
	...
	GetDelimiter1() string
	GetConstraint() ConstraintLike
	GetAdditionalConstraints() com.Sequential[AdditionalConstraintLike]
	GetDelimiter2() string
}
...
type ConstructorSubsectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetConstructorMethods() com.Sequential[ConstructorMethodLike]
}
...
type EnumerationLike interface {
	...
	GetDelimiter2() string
	GetValue() ValueLike
	GetAdditionalValues() com.Sequential[AdditionalValueLike]
	GetDelimiter3() string
}
...
type FunctionSubsectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetFunctionMethods() com.Sequential[FunctionMethodLike]
}
...
type FunctionalSectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetFunctionalDeclarations() com.Sequential[FunctionalDeclarationLike]
}
...
type ImportListLike interface {
	...
	// Attribute Methods
	GetImportedPackages() com.Sequential[ImportedPackageLike]
}
...
type InstanceSectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetInstanceDeclarations() com.Sequential[InstanceDeclarationLike]
}
...
type PrincipalSubsectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetPrincipalMethods() com.Sequential[PrincipalMethodLike]
}
...
type TypeSectionLike interface {
	...
	// Attribute Methods
	GetDelimiter() string
	GetTypeDeclarations() com.Sequential[TypeDeclarationLike]
}
